...
function CommentItem({username, body}: {username: string, body: string}) {
    return (
        <div className={styles.comment__wrapper}>
            <div className={styles.comment__info}>
                <div className={styles.comment__username}>@{username}</div>
                <div className={styles.comment__text}>{body}</div>
            </div>
