...
import ArticleSceleton from "./ArticleSceleton.tsx";
    ...
    return (
        <div className={styles.articles__wrapper}>
            ...
            <div className={styles.articles__pagination}>
                ...
                <svg onClick={() => handleNextArticles()} style={(articles.skip < articles.total && articles.limit === 12) ? {fill: '#605E5E'} : {fill: '#CECECE'}} width="46" height="30" viewBox="0 0 46 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path fillRule="evenodd" clipRule="evenodd"
